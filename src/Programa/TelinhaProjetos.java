 ...
 *
 */
public class TelinhaProjetos extends JFrame{
	...
	/**
	 * Método construtor que chama a função para criar um formulário de cadastro
	 */
	public TelinhaProjetos() {
		super("cadastro de projeto");
		criarFormulario();
	}
public boolean valida() {
		
		if(nomegerenteField.getText().trim().isEmpty())
			nomegerenteField.setBorder(new LineBorder(Color.red));
		...
		if(nomegerenteField.getText().trim().isEmpty()==false)
			nomegerenteField.setBorder(new LineBorder(Color.gray));
	...
	/**
	 * Método que recebe a String do formulário anterior
	 * @param recebe
	 */
	public void recebendo(String recebe) {
		nomegerenteField.setText(recebe);
		nomegerenteField.setEditable(false);
	}
	
	String select;
	JTextField nomegerenteField= new JTextField(30);
	...
	public void criarFormulario() {
		...
		JLabel nomegerenteLabel = new JLabel("Gerente");
		
		nomegerenteLabel.setBounds(50,50,100,20);
		nomegerenteField.setBounds(150,50,400,20);
		
		JLabel nomeLabel = new JLabel("Título do projeto");
		nomeLabel.setBounds(50,80,100,20);
		nomeField.setBounds(150,80,400,20);
		...
		panelCadastro.add(nomegerenteField);
		panelCadastro.add(dataLabel1);
		panelCadastro.add(this.dataField1);
		panelCadastro.add(dataLabel2);
		panelCadastro.add(this.dataField2);
		...
		botaoSalvar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Projetos g= new Projetos();
				String nome = null;
				nome=nomeField.getText();
				g.setNome(nome);
				
				String nome1 = null;
				nome1=nomegerenteField.getText();
				g.setNome(nome1);
				...
				valida();
				if(valida()==true) {
					g.cadastroprojeto(nome, nome1, data, data1, area,area1,area2,area3);
